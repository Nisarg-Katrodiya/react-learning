...
function makeMongoDbService({ model }) {
  ...
  const getDocumentById = (id, select = []) => new Promise((resolve, reject) => {
  ...
  const getDocumentByQuery = (where, select = []) => new Promise((resolve, reject) => {
  ...
  const getCountDocumentByQuery = (where) => new Promise((resolve, reject) => {
  ...
  const getDocumentByQueryPopulate = (where, select = [], population = [], pageNumber, pageSize, sort = {}) => new Promise((resolve, reject) => {
  ...
  const getSingleDocumentByQueryPopulate = (where, select = [], population = []) => new Promise((resolve, reject) => {
    model.findOne(where)
    .populate(population)
    .select(select)
    .then(data => {
  ...
  const getSingleDocumentByIdPopulate = (id, select = [], population = []) => new Promise((resolve, reject) => {
  ...
  const hardDeleteDocument = (id) => new Promise(async (resolve, reject) => {
    model.find({ _id:id }).remove().exec();
    resolve('No Data Found');
  });

  const softDeleteByQuery = (query) => new Promise(async (resolve, reject) => {
